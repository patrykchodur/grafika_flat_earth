...
bool loadOBJ(
	...
	for( unsigned int i=0; i<vertexIndices.size(); i++ ){
		...
		sf::Vector2f uv = temp_uvs[ uvIndex-1 ];
		sf::Vector3f normal = temp_normals[ normalIndex-1 ];
...
bool loadAssImp(
	...
	for(unsigned int i=0; i<mesh->mNumVertices; i++){
		...
		vertices.push_back(sf::Vector3f(pos.x, pos.y, pos.z));
	}
	...
	for(unsigned int i=0; i<mesh->mNumVertices; i++){
		...
		uvs.push_back(sf::Vector2f(UVW.x, UVW.y));
	}
	...
	for(unsigned int i=0; i<mesh->mNumVertices; i++){
		...
		normals.push_back(sf::Vector3f(n.x, n.y, n.z));
	}
